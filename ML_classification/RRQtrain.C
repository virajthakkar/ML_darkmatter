...
int RRQtrain( TString myMethodList = "" )
{
   ...
   string featurename1,featurename2,featurename3,featurename4,featurename5,featurename6,featurename7;
...
TCut virajchargeradialcut("qo1OF<1.05087 && qo2OF<1.23711");
  ...
  TCut threesigmacut("( (qi1OF+qi2OF)/2.0 ) > 0.95*precoiltNF -10 && ((qi1OF+qi2OF)/2.0) >3 ");
  ...
  TCut mycuts = qimeancut+!newERNRcut; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
...
double q_y_range_2=160; //Prev: 80, 14
   ...
   TH2D *hERNR_bkg = new TH2D("hERNR_bkg","ER NR", precoiltNFbinsize, precoiltNFrange_1, precoiltNFrange_2, qbinsize, q_y_range_1, q_y_range_2);
...
hERNR_bkg->GetYaxis()->SetTitleSize(0.03);
   ...
   float_t precoiltNF_gamma,ytNF_gamma, qzpartOF_gamma,qrpart1OF_gamma,pzpartOF_gamma,prpartOF_gamma,qsummaxOF_gamma;
  
float_t PTNFchisq_gamma,
ptNF_gamma,
PTOFchisq_gamma,
PTglitch1OFchisq_gamma,
PTlfnoise1OFchisq_gamma,
QS1OFchisq_gamma,
qsum1OF_gamma,
QS2OFchisq_gamma,
qsum2OF_gamma,
...
backgroundtree->SetBranchAddress("PTlfnoise1OFchisq",&PTlfnoise1OFchisq_gamma);
...
TCanvas *can;
    can = new TCanvas("can","",10,10,600,600);
     ...
     TH2D *hERNR_sig = new TH2D("hERNR_sig","ER NR", precoiltNFbinsize, precoiltNFrange_1, precoiltNFrange_2, qbinsize, q_y_range_1, q_y_range_2);
...
float_t precoiltNF_signal,ytNF_signal, qzpartOF_signal,qrpart1OF_signal,pzpartOF_signal,prpartOF_signal,qsummaxOF_signal;
float_t PTNFchisq_signal,
ptNF_signal,
PTOFchisq_signal,
PTglitch1OFchisq_signal,
PTlfnoise1OFchisq_signal,
QS1OFchisq_signal,
qsum1OF_signal,
QS2OFchisq_signal,
qsum2OF_signal,
...
signalTree->SetBranchAddress("PTlfnoise1OFchisq",&PTlfnoise1OFchisq_signal);
...
signalTree->SetBranchAddress("qi2OF",&qi2OF_signal);


signalTree->SetBranchAddress("qimean",&qimean_signal);


signalTree->SetBranchAddress("precoiltNF",&precoiltNF_signal);
signalTree->SetBranchAddress("ytNF", &ytNF_signal);
signalTree->SetBranchAddress("qzpartOF", &qzpartOF_signal);
signalTree->SetBranchAddress("qrpart1OF", &qrpart1OF_signal);
signalTree->SetBranchAddress("pzpartOF", &pzpartOF_signal);
signalTree->SetBranchAddress("prpartOF", &prpartOF_signal);
signalTree->SetBranchAddress("qsummaxOF", &qsummaxOF_signal);
